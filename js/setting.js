...
OpenSpending.Styles.Cofog = {
  ...
  '2-2': { icon: 'icons/dollar.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-3': { icon: 'icons/books.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-4': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-5': { icon: 'icons/research.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-6': { icon: 'icons/police.svg', color: '#C75746', bcolor: '#0AB971' },
  ...
  '3-3': { icon: 'icons/old-age.svg', color: '#C75746', bcolor: '#4E6D00' },
  '3-4': { icon: 'icons/pre-school.svg', color: '#C75746', bcolor: '#4E6D00' },
  '3-5': { icon: 'icons/wheelchair.svg', color: '#C75746', bcolor: '#4E6D00' },
  '3-6': { icon: 'icons/aid-developing-countries.svg', color: '#C75746', bcolor: '#4E6D00' },
  ...
  '4-2': { icon: 'icons/toilet.svg', color: '#C75746', bcolor: '#D33673' },
  ...
  '6-2': { icon: 'icons/pig.svg', color: '#C75746', bcolor: '#EC2406' },
  '6-3': { icon: 'icons/environment.svg', color: '#C75746', bcolor: '#EC2406' },
  '6-4': { icon: 'icons/tree.svg', color: '#C75746', bcolor: '#EC2406' },
  '7': { icon: 'icons/economic-aid.svg', color: '#C75746', bcolor: '#938626' },
  '7-1': { icon: 'icons/economic-aid.svg', color: '#C75746', bcolor: '#938626' },
  '7-2': { icon: 'icons/economy-tourism.svg', color: '#C75746', bcolor: '#938626' },
  ...
  '8-2': { icon: 'icons/street-lights.svg', color: '#C75746', bcolor: '#C75746' },
  '8-3': { icon: 'icons/island.svg', color: '#C75746', bcolor: '#C75746' },
  '8-4': { icon: 'icons/manufactoring-construction.svg', color: '#C75746', bcolor: '#C75746' },
  '8-5': { icon: 'icons/housing.svg', color: '#C75746', bcolor: '#C75746' },
  '8-6': { icon: 'icons/toilet.svg', color: '#C75746', bcolor: '#C75746' },
  ...
  '10-3': { icon: 'icons/schools.svg', color: '#C75746', bcolor: '#790586' },
  '10-4': { icon: 'icons/pre-school.svg', color: '#C75746', bcolor: '#790586' },
  '10-5': { icon: 'icons/misc-services.svg', color: '#C75746', bcolor: '#790586' },
  '10-6': { icon: 'icons/sports.svg', color: '#C75746', bcolor: '#790586' },
  '11': { icon: 'icons/money.svg', color: '#C75746', bcolor: '#790586' },
  '11-1': { icon: 'icons/money.svg', color: '#C75746', bcolor: '#790586' },
  '12': { icon: 'icons/public-debt.svg', color: '#C75746', bcolor: '#790586' },
  '12-1': { icon: 'icons/energy.svg', color: '#C75746', bcolor: '#790586' },
  '12-2': { icon: 'icons/money.svg', color: '#C75746', bcolor: '#790586' },
